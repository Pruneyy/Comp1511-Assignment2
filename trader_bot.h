...
#define MAX_BOT_NAME_CHARS               (MAX_SUPPLIED_BOT_NAME_CHARS + 12)
...
//
//  bots - pointer to a linked list of bots currently at this location NULL if is no bot at this location
//
//
